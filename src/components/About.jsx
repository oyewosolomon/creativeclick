...
const About = () => {
  return (
    <div id="our-company" className="text-black flex flex-col bg-white dark:bg-black dark:text-white min-h-screen p-8">
        ...
        <div className="mt-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400">
              We ensure that our lenses LIGHT up your business always.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <ValueCard
              icon={Heart}
              title="Loyalty"
              description="We are dedicated to our clients and partners, providing unwavering support and commitment."
            />
            <ValueCard
              icon={Lightbulb}
              title="Innovation"
              description="We pursue creative and cutting-edge solutions to drive success and differentiation."
            />
            <ValueCard
              icon={TrendingUp}
              title="Growth"
              description="We are committed to continuous improvement and innovation, driving progress for our clients and ourselves."
            />
            <ValueCard
              icon={ShieldCheck}
              title="Honesty"
              description="We maintain transparency in our communications and build trust with our clients and partners."
            />
          </div>
        </div>
      </div>
