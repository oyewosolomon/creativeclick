      ...
      {open && (
        <motion.div
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "min-h-[50%] max-h-[95%] max-w-[90%] md:max-w-[40%] bg-white dark:bg-neutral-950 border border-transparent dark:border-neutral-800 rounded-2xl md:rounded-2xl relative z-50 flex flex-col flex-1 overflow-hidden",
              className
            )}
            initial={{
              opacity: 0,
